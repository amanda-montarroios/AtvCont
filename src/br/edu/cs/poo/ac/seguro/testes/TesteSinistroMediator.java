...
//             Assertions.fail();
//         } catch (ExcecaoValidacaoDados e) {
//             Assertions.assertEquals("N�o existe ap�lice vigente para o ve�culo", e.getMensagens().get(0));
//         }
//     }
...
//     public void teste08() {
//         try {
//             // Dados do segurado, veículo e apólice com valor segurado
//             String cpf = "12345678900";
//             String placa = "KKK0001";
//             String numero = "123456";
//             SeguradoPessoa sp = new SeguradoPessoa("ED MOTA", null, null, BigDecimal.ZERO, cpf, 10000.0);
...
//             Assertions.fail();
//         } catch (ExcecaoValidacaoDados e) {
//             Assertions.assertEquals("Valor do sinistro n�o pode ultrapassar o valor m�ximo segurado constante na ap�lice", e.getMensagens().get(0));
//         }
//     }
...
//     public void teste09() {
//         try {
//             // Preparação completa de dados para inclusão válida
//             String cpf = "12345678900";
//             String placa = "KKK0001";
//             String numero = "123456";
...
//             cadApolice.incluir(ap, numero);
//             DadosSinistro dados = new DadosSinistro(placa, dhSinistro, usuario, valorSinistro, 1);
