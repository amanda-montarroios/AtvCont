...
public class TesteApoliceMediator extends TesteMediator {
    ...
    public void test010() {
        ...
        Apolice ap = new Apolice(vel, new BigDecimal("1800.00"),
                new BigDecimal("2340.00"), new BigDecimal("60000.00"));
        cadastro.incluir(ap, numero);
    ...
    public void test011() {
        ...
        Apolice apEsp = new Apolice(
                velEsp,
                new BigDecimal("1952.00"),
                new BigDecimal("2667.60"),
                new BigDecimal("57000.00")
        );
        apEsp.setNumero(NUM_AP);
